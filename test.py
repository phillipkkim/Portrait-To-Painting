...
if __name__ == '__main__':
    ...
    for i, data in enumerate(dataset):
        ...
        util.save_image(real_im, os.path.join(
            real_dir, str(i)+".png"), aspect_ratio=opt.aspect_ratio)
        util.save_image(fake_im, os.path.join(
            fake_dir, str(i)+".png"), aspect_ratio=opt.aspect_ratio)
