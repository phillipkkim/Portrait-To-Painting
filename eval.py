...
parser.add_argument('path', type=str, nargs=1,
                    help=('folder for images holding fake and target_style directories'))
...
if __name__ == '__main__':
    ...
    images = imgs2tensors(path)
    print("Calculating Inception Score...")
    print(inception_score.inception_score(images, cuda=False, resize=True))
